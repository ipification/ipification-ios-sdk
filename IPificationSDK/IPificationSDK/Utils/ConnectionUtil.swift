...
class ConnectionUtil {
    public static func resolveDNS(_ name: String) -> String {
        
        let remoteHostEnt = gethostbyname2((name as NSString).utf8String, AF_INET6)
        ...
        inet_ntop(AF_INET6, remoteAddr, &output, socklen_t(INET6_ADDRSTRLEN))
        return NSString(utf8String: output)! as String
    }
    
   public static func validIPAddress(_ ipToValidate: String) -> String {
