...
/// Searches the country metadata bundled with the SDK.
public class IsoCountryCodes {
    /// Finds a country by alpha-2 or alpha-3 code.
    ...
    /// Finds the first country whose name matches the supplied value.
    ...
    /// Finds a country by ISO numeric code.
    ...
    /// Returns all countries that use the supplied currency code.
    ...
    /// Returns all countries that use the supplied telephone calling code.
